Ext.define('CareMe.model.Contact', {
    ...
    config: {
        fields: [
            ...
            {name: 'targetPhoneNumber', type :'string', convert: function(val, rec) {return rec.raw.phoneNumbers && rec.raw.phoneNumbers[0] && rec.raw.phoneNumbers[0].value;} },
